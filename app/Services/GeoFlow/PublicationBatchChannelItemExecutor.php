    ...
    public function execute(PublicationBatchItem $item): PublicationBatchItem
    {
        $claimed = DB::transaction(function () use ($item): PublicationBatchItem {
            ...
            try {
                ...
                $gate = PublicationGateContract::evaluate($project, (string) $article->status, (string) $article->review_status, PublicationGateContract::TARGET_CHANNEL, true, (bool) $article->central_site_allowed);
                if (! $gate['allowed']) {
